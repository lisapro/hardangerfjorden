...
fig = plt.figure(figsize=(10.27,6.0), dpi=100)
gs = gridspec.GridSpec(1,2)
gs.update(left = 0.05,right = 0.93,bottom = 0.05, top = 0.95,hspace=0.07)
ax = fig.add_subplot(gs[0])
txtsize = 12
#gs2 = gridspec.GridSpec(1,1)
#gs2.update(left = 0.65,right = 0.95,bottom = 0.2, top = 0.99) 
...
map.drawparallels(parallels, labels = [1,1,0,0], size = txtsize) # draw parallels
map.drawmeridians(meridians, labels = [0,0,1,1], size = txtsize) # draw parallels

map2.drawparallels(parallels2, labels = [1,1,1,1], size = txtsize) # draw parallels
map2.drawmeridians(meridians2, labels = [1,1,1,1], size = txtsize) # draw parallels
...
plot_m(lon_sed199, lat_sed199,map2,dot_size,sed_color,s_ecolor,"Sediment station")
plot_m(lon_sed200, lat_sed200,map2,dot_size,sed_color,s_ecolor)
...
plot_m(x_farm6,y_farm6,map2,starsize,farmcolor,star_ecolor,None,"*")  
plot_m(x_farm7,y_farm7,map2,starsize,farmcolor,star_ecolor,None,"*")  
plot_m(x_farm8,y_farm8,map2,starsize,farmcolor,star_ecolor,None,"*")  
...
to_annotate('st199', (x_sed1,y_sed1),(10, -15),ax2) 
